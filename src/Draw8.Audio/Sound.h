...
namespace Draw8
{
	namespace Audio
	{
		ref class SoundSource;

		///<summary>A sound instantiated from a simple sound source.</summary>
		public ref class Sound sealed : public ISound
		{
			private:
				//Contains the buffer
			...
			internal:
				//Creates an instance
				Sound(SoundEngine^ Engine, SoundSource^ Source, LoopInfo^ LoopInfo, Platform::Array<SoundTarget^>^ Targets);
			...
			public:
				...
				property bool Looped { virtual bool get() { return m_looped->Times > 1; } }
